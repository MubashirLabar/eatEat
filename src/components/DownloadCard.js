...
function DownloadCard(props) {
    return (
        <div className="dwld-blk flex rel">
            <div className="lef flex flex-col">
                <div className="tit font s26 b6 cfff">Put us in your Pocket</div>
                <div className="blk">
                    <div className="lb font s18 b4 cfff">Download the food you love</div>
                ...
                <div className="actions">
                    <div className="lbl font s15 b5 cfff">Go ahead, download us.</div>
